...
export const translations: TranslationMap = {
  ...
  "nav.map":           { en: "Live Tactical Map",    hi: "लाइव मानचित्र",      mr: "लाइव नकाशा" },
  "nav.incidents":     { en: "Critical Incidents",   hi: "गंभीर घटनाएं",       mr: "गंभीर घटना" },
  "nav.alerts":        { en: "Alert Center",         hi: "अलर्ट केंद्र",       mr: "अलर्ट केंद्र" },
  "nav.dindis":        { en: "Dindi & Palkhi Sync",  hi: "दिंडी और पालखी",     mr: "दिंडी आणि पालखी" },
  "nav.resources":     { en: "Resource & Water",     hi: "संसाधन और पानी",     mr: "संसाधन आणि पाणी" },
  ...
  "nav.simulator":     { en: "Scenario Simulator",   hi: "परिदृश्य सिमुलेटर",  mr: "परिदृश्य सिम्युलेटर" },
  ...
  "nav.section.tracking":   { en: "Pilgrimage Tracking",    hi: "तीर्थयात्रा ट्रैकिंग", mr: "यात्रा ट्रॅकिंग" },
  ...
  "header.route":     { en: "240km Corridor • Pune → Pandharpur",   hi: "240km गलियारा • पुणे → पंढरपूर", mr: "240km मार्ग • पुणे → पंढरपूर" },
  "header.pilgrims":  { en: "Pilgrims",                             hi: "तीर्थयात्री",                 mr: "वारकरी" },
  "header.critical":  { en: "Critical Alert",                       hi: "गंभीर अलर्ट",                 mr: "गंभीर इशारा" },

  // ── Common ────────────────────────────────────────────────────────────────
  "common.live":       { en: "LIVE",      hi: "लाइव",        mr: "लाइव्ह" },
  "common.simulated":  { en: "Simulated", hi: "अनुकरणीय",   mr: "सिम्युलेटेड" },
  ...
  "common.resolved":   { en: "Resolved",  hi: "हल किया",     mr: "निराकरण झाले" },
  ...
  // ── Commander's Brief ─────────────────────────────────────────────────────
  "brief.title":            { en: "Commander's Brief",        hi: "कमांडर का संक्षिप्त विवरण", mr: "कमांडरचे थोडक्यात" },
  "brief.requiresAttention":{ en: "situations require attention", hi: "स्थितियों पर ध्यान आवश्यक", mr: "परिस्थितींकडे लक्ष द्यावे" },
  ...
  "brief.viewIncident":     { en: "View Incident",            hi: "घटना देखें",                  mr: "घटना पहा" },
  "brief.executeResponse":  { en: "Execute Response",         hi: "प्रतिक्रिया निष्पादित करें", mr: "प्रतिसाद अंमलात आणा" },
  ...
  "copilot.placeholder": { en: "Ask about checkpoint density, water levels, crowd flow…", hi: "चेकपॉइंट घनत्व, पानी स्तर के बारे में पूछें…", mr: "चेकपॉइंट घनता, पाण्याची पातळी विचारा…" },
  ...
  "copilot.notSupported":{ en: "Speech not supported in this browser", hi: "इस ब्राउज़र में वाणी समर्थित नहीं", mr: "या ब्राउझरमध्ये वाणी उपलब्ध नाही" },
  ...
  "map.forecast":    { en: "45-min Forecast",           hi: "45 मिनट का अनुमान",            mr: "45 मिनिट अंदाज" },
  ...
  // ── Login ──────────────────────────────────────────────────────────────────
  "login.title":       { en: "WariOS Operations Portal",             hi: "वारीओएस संचालन पोर्टल",           mr: "वारीओएस कार्यचालन पोर्टल" },
  "login.subtitle":    { en: "Select your role to enter the pilgrimage command center", hi: "तीर्थयात्रा कमांड सेंटर में प्रवेश करने के लिए भूमिका चुनें", mr: "वारी कमांड सेंटरमध्ये प्रवेश करण्यासाठी तुमची भूमिका निवडा" },
  "login.launch":      { en: "Launch View",                          hi: "व्यू लॉन्च करें",                 mr: "व्ह्यू लॉन्च करा" },
  ...
  "page.commandCenter.subtitle": { en: "Ashadhi Ekadashi Pilgrimage Operations — Pune to Pandharpur Corridor", hi: "आषाढी एकादशी तीर्थयात्रा संचालन — पुणे से पंढरपूर गलियारा", mr: "आषाढी एकादशी वारी संचालन — पुणे ते पंढरपूर मार्ग" },
  "page.commandCenter.focus":    { en: "Your Priority Focus Areas:",  hi: "आपके प्राथमिकता क्षेत्र:", mr: "तुमचे प्राधान्य क्षेत्र:" },
  ...
  "page.commandCenter.roleNote": { en: "KPIs and alerts are prioritized for your role. Switch roles from the sidebar.", hi: "KPI और अलर्ट आपकी भूमिका के अनुसार प्राथमिकता में हैं। साइडबार से भूमिका बदलें।", mr: "KPI आणि इशारे तुमच्या भूमिकेनुसार प्राधान्यित आहेत। साइडबारमधून भूमिका बदला." },

  // ── Decision stages ────────────────────────────────────────────────────────
  "stage.detected":    { en: "Detected",    hi: "पता लगाया",    mr: "आढळले" },
  ...
  "stage.dispatched":  { en: "Dispatched",  hi: "प्रेषित",      mr: "पाठवले" },
  ...
  // ── Live GPS & Dindi ───────────────────────────────────────────────────────
  "gps.liveBeacon":    { en: "Live GPS Beacon",      hi: "लाइव जीपीएस बीकन",      mr: "थेट जीपीएस बीकन" },
  "gps.broadcasting":  { en: "GPS Broadcasting",     hi: "जीपीएस प्रसारण सक्रिय",   mr: "जीपीएस प्रसारण सुरू" },
  "gps.centerLocation":{ en: "Center on My Location",hi: "मेरे स्थान पर केंद्रित करें",mr: "माझ्या स्थानावर केंद्रित करा" },
  "role.dindiLeader":  { en: "Dindi Pramukh / Leader", hi: "दिंडी प्रमुख / पालखी लीडर", mr: "दिंडी प्रमुख / पालखी नेते" },
};
